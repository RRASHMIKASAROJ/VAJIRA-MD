...
const BOTNAME = 'PROFESH RASH|-WA-BOT™';
const FOOTERNAME = '> PROFESH RASH -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '94783681488' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=fUVxnISY#NGfp6zs8dpWcUK87yC9rFQhSwAXgKDuCB437yydgXd0' ,
...
FOOTER: process.env.FOOTER || '‌👨‍💻 PROFESH RASH -  ＭＤ - Ｖ5 👨‍💻',    
